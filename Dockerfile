...
RUN zypper install -y -l libqwt-qt5-5-devel libqt5-qtsvg-devel  libqt5-qtwayland libqwtplot3d-qt5-0-devel libtirpc-devel muparser-devel libboost_python3-devel python3-devel glu-devel python3-numpy liborigin-evel libqt5-linguist-devel
# LaTeX
RUN zypper --non-interactive install -y -l  texlive-collection-latex latex2html texlive-epstopdf-bin
